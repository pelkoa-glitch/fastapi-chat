...
def convert_message_document_to_entity(message_document: Mapping[str, Any]) -> Message:
    return Message(
        ...
        is_manager=message_document['is_manager'],
    )


def covert_chat_listener_document_to_entity(listener_id: str) -> ChatListener:
...
def convert_chat_document_to_entity(chat_document: Mapping[str, Any]) -> Chat:
    return Chat(
        ...
        listeners={
            covert_chat_listener_document_to_entity(listener_id=listener_id)
