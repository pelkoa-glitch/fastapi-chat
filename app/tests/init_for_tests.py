...
from logic.queries.messages import (
    ...
    GetAllChatListenersQueryHandler,
    GetAllChatsQuery,
...
def _init_container() -> Container:
    ...
    container.register(BaseChatsRepository, instance=MemoryChatRepository(), scope=Scope.singleton)
    ...
    container.register(GetAllChatListenersQueryHandler)
    ...
    # Message broker
    container.register(BaseMessageBroker, instance=DummyMessageBroker(), scope=Scope.singleton)
    ...
    def init_mediator() -> Mediator:
        ...
        add_telegram_listener_handeler = AddTelegramListenerHandler(
            _mediator=mediator,
            chats_repository=container.resolve(BaseChatsRepository),
        )
        ...
        new_listener_added_event_handelr = ListenerAddedEventHandler(
            message_broker=container.resolve(BaseMessageBroker),
        ...
        mediator.register_event(
            ListenerAddedEvent,
            [new_listener_added_event_handelr],
        )
        ...
        mediator.register_command(
            AddTelegramListenerCommand,
            [add_telegram_listener_handeler],
        )
        ...
        mediator.register_query(
            GetAllChatListenersQuery,
            container.resolve(GetAllChatListenersQueryHandler),
        )
        return mediator
